...
// locked[i][j] means i is locked in over j; if [i][j] is true then arrow is locked (or pointing)
...
// Input needs to be winner, loser in question; Eventualmente locked tiene que tener una columna
// llena de cero pq no hay mas de dos sources
